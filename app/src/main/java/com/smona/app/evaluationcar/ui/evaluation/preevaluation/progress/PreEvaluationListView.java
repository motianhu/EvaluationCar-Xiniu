...
public class PreEvaluationListView extends PullableListView implements
        OnScrollListener {

    private static final String TAG = PreEvaluationListView.class.getSimpleName();
    private PreEvaluationListAdapter mListAdapter = null;
    ...
    public PreEvaluationListView(Context context) {
        super(context);
        init(context);
    }

    public PreEvaluationListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        mListAdapter = new PreEvaluationListAdapter(context);

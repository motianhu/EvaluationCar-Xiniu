...
public class QuickUploadTaskExecutor {
    private static final String TAG = QuickUploadTaskExecutor.class.getSimpleName();

    private static final int MULTI_THREAD_COUNT = 2;
    private static QuickUploadTaskExecutor sInstance;
    ...
    private QuickUploadTaskExecutor() {
    }

    public static QuickUploadTaskExecutor getInstance() {
        if (sInstance == null) {
            sInstance = new QuickUploadTaskExecutor();
        }
        return sInstance;
    }

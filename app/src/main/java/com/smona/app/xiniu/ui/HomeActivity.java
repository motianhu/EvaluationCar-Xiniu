...
public class HomeActivity extends UserActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    private void initViews() {
        ...
        mRadioFunc[0] = (RadioButton) findViewById(R.id.rb_evaluation);
        mRadioFunc[1] = (RadioButton) findViewById(R.id.rb_list);
        mRadioFunc[2] = (RadioButton) findViewById(R.id.rb_setting);

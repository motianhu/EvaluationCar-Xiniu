package com.smona.app.xiniu.ui.status.pass;
...
import com.smona.app.xiniu.ui.status.StatusActivity;
...
public class PassAdapter extends BaseAdapter implements View.OnClickListener {
